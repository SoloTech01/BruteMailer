**BruteMailer is a python3 tool for hacking different email services' user accounts such as Gmai,outlook, it also comes with a built-in password generator**
