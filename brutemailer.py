...
print(lr)
print("WARNING: BRUTEMAILER WAS CREATED BY I,SOLOMON ADENUGA FOR EDUCATIONAL PURPOSES AND WON'T I BE RESPONSIBLE FOR ANY MISUSE OF THE TOOL")
print("\n")
...
[1] Gmail
[2] Outlook
[3] Yahoo {lr}(unavailable){RESET}{GREEN}
